...
class AIThread(QThread):
    ...
    def run(self):
        ai = AlphaBetaAI(self.chessboard, 2) # my color: 2
        ...
        # Get the best position regarding the current chessboard situation
...
class MyMainForm(QMainWindow, Ui_MainWindow):
    ...
    def ai_draw(self,result):
        ...
        self.status = 1
        self.label_7.setText("It's your turn!")
        # 判断输赢
        self.judge(i, j)
    ...
    def draw(self,i,j,a):
        ...
        self.step += 1
        self.label_2.setText("STEPS：{}".format(self.step))
